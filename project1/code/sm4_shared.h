...
// 定义SM4算法的核心参数
constexpr int SM4_NUM_ROUNDS = 32;
constexpr int SM4_KEY_SIZE = 16;   // 128 bits
constexpr int SM4_BLOCK_SIZE = 16; // 128 bits
...
inline void from_uint32(uint32_t v, uint8_t* p) {
    p[0] = (uint8_t)(v >> 24);
    p[1] = (uint8_t)(v >> 16);
    p[2] = (uint8_t)(v >> 8);
    p[3] = (uint8_t)v;
